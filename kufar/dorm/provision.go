...
func CreateProvision(d Database) func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if _, err := d.db.Exec("insert into provisions(id, bedsheet, pillow, towel, blanket, curtain) values($1, $2, $3, $4, $5)",pr.ID, pr.Bedsheet, pr.Pillow, pr.Towel, pr.Blanket, pr.Curtain); err != nil {
